...
//        file_put_contents('onMessage-swap_kline_1day1.log',json_encode($con));
//        file_put_contents('onMessage-swap_kline_1day2.log',json_encode($data));
//        file_put_contents('onMessage-swap_kline_1day3.log',json_encode($ok));
            ...
            if (isset($data['ping'])) {
                ...
                if($cache_data){
                    ...
                    if (Gateway::getClientIdCountByGroup($group_id2) > 0) {
                        Gateway::sendToGroup($group_id2, json_encode(['code' => 0, 'msg' => 'success', 'data' => $cache_data['data'], 'sub' => $group_id2, 'type' => 'dynamic']));
                    }
                }
